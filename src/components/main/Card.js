...
export default class Card extends React.Component {
  ...
  render() {
    ...
    const cardStyle = "h-auto w-auto bg-white ml-4 mt-4 rounded-lg shadow hover:shadow-md cardBody overflow-hidden"
    const cardImageStyle = {backgroundImage:`url(${url}${foto})`,  backgroundRepeat: "no-repeat", backgroundPosition:"center"}
    const cardDetailClass = "text-gray-800"
    const cardContentStyle = "p-4 h-40 flex flex-col justify-between"
    return (
      <div className= {cardStyle}>
      {/* <a href={verMas}> */}
          <div className="h-48 bg-cover" style={cardImageStyle}>
          </div>
          <div className={cardContentStyle}>
            ...
            <div className={bottomRow} >
              ...
              <span className="text-right text-blue-700 hover:font-black" onClick={handleModal} style={{cursor:"pointer "}}> Ver Mas</span>
            </div>
          </div>
        {/* </a> */}
      </div>
