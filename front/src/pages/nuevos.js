...
const Nuevos = () => {
  return (
    <div className="pt-24 overflow-hidden mt-8 max-w-6xl mx-auto px-16 mb-16 shadow-2xl rounded-lg pb-16">
      ...
      <iframe width="853" height="480" src="https://www.youtube.com/embed/ryrb1rhLDIY" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen title="video" className="mx-auto"></iframe>
    </div>
  );
};
